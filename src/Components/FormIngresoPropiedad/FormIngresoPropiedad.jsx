...
import { ingresoPropiedad } from "../../API/Rule_inmuebles";
import "./FormIngresoPropiedad.css";

function FormIngresoPropiedad() {
  ...
  const onSubmit = async (data) => {
    ...
    await ingresoPropiedad(formData, config)
      .then(() => {
  ...
  return (
    <div className="formContainer">
      <form onSubmit={handleSubmit(onSubmit)} className="formIngreso">
        ...
        {errors.nombre?.type === "required" && (
          <span>Ingrese la descripción</span>
        )}
        ...
        />
        {errors.metros_cuadrados?.type === "required" && (
          <span>Ingrese el area</span>
        )}
        ...
        {errors.precio_venta?.type === "required" && (
          <span>Debe ingresar un precio</span>
        )}
        ...
        {errors.departamento?.type === "required" && (
          <span>Ingrese un departamento</span>
        )}
        ...
        {errors.direccion?.type === "required" && (
          <span>Ingrese la dirección</span>
        )}
...
export default FormIngresoPropiedad;
